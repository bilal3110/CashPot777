                            ...
                            <div class="col-lg-12 mb-4 order-0">
                                <div class="col-lg-4 col-md-6">
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel3">Add Office Spendings</h5>
                                                ...
                                                <div class="modal-body">
                                                    <form>
                                                        <div class="mb-3">
                                                          <label class="form-label" for="basic-default-fullname">Liability/Product</label>
                                    ...
                                    <div class="demo-inline-spacing">
                                      <h1 style="font-size: 20px; font-weight: 700; padding-top: 10px;">Manage Spendings</h1>
                                  ...
                                  <div class="table-responsive text-nowrap">
                                      <table class="table">
                                          ...
                                          <tbody class="table-border-bottom-0">
                                              <tr>
                                                  <td>
                                                      <span class="fw-medium">Electricity Bill</span>
                                                  </td>
                                                  <td>10000</td>
                                                  <td>1200 sqft</td>
                                                  <td>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat, molestias!</td>
                                                  <td>2-2-2025</td>
                                                  <td>
